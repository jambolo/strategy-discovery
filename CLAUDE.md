...
cargo run -- <subcommand>   # CLI stages: play, generate, annotate, analyze, report, evaluate, pipeline
```
...
- `src/discovery/` — corpus generation runner, annotation stage, strategy archive.
